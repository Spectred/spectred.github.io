import{ab as n,G as d,H as i,ac as a,E as e}from"./framework-11534bf9.js";const o={},s=a(`<h2 id="备份和恢复" tabindex="-1"><a class="header-anchor" href="#备份和恢复" aria-hidden="true">#</a> 备份和恢复</h2><blockquote><p>任意时间点备份恢复=全量备份(mongodump/复制数据库文件/文件系统快照) + oplog</p></blockquote><h4 id="mongodump" tabindex="-1"><a class="header-anchor" href="#mongodump" aria-hidden="true">#</a> <code>mongodump</code></h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mongodump -h HOST -d DB_NAME -o 备份的数据存放位置
