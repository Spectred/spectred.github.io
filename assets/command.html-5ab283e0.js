import{_ as a,V as e,W as n,a4 as s}from"./framework-b6120433.js";const i={},t=s(`<h1 id="命令" tabindex="-1"><a class="header-anchor" href="#命令" aria-hidden="true">#</a> 命令</h1><h2 id="_1-tee" tabindex="-1"><a class="header-anchor" href="#_1-tee" aria-hidden="true">#</a> 1. <code>tee</code></h2><p>1.1向文件中追加内容</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">tee</span> <span class="token parameter variable">-a</span> a.txt <span class="token operator">&lt;&lt;-</span><span class="token string">&#39;EOF&#39;
hello
world
EOF</span>
