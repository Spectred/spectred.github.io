import{_ as e,V as n,W as s,a3 as a}from"./framework-d0eb6f2b.js";const i={},d=a(`<h3 id="_1-向文件中追加内容-tee" tabindex="-1"><a class="header-anchor" href="#_1-向文件中追加内容-tee" aria-hidden="true">#</a> 1. 向文件中追加内容(<code>tee</code>)</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">cat</span> a.txt 
Hello World
--- 
