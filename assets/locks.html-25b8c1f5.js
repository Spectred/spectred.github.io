...
<span class="token keyword">void</span> <span class="token function">method</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11),r={class:"hint-container info"},u=n("p",{class:"hint-container-title"},"临界区",-1),v={href:"https://en.wikipedia.org/wiki/Critical_section",target:"_blank",rel:"noopener noreferrer"},k=t(`<p>使用<code>synchronized</code>确保多线程安全访问共享资源的代码示例</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SynchronizedExample</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
    ...
    Code:
      ...
      LineNumberTable:
        line 7: 0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16),S={class:"hint-container info"},M=n("p",{class:"hint-container-title"},"在JVM源码中的实现",-1),T={href:"https://github.com/openjdk/jdk/blob/master/src/hotspot/share/runtime/objectMonitor.hpp",target:"_blank",rel:"noopener noreferrer"},W={href:"https://github.com/openjdk/jdk/blob/jdk-17-ga/src/hotspot/share/runtime/objectMonitor.cpp",target:"_blank",rel:"noopener noreferrer"},N=n("h2",{id:"_2-显式锁-lock",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-显式锁-lock","aria-hidden":"true"},"#"),a(" 2. 显式锁 "),n("code",null,"Lock")],-1),O=n("p",null,"锁时用来控制多个线程访问共享资源的方式，一般来说一个锁能够防止多个线程同时访问共享资源。",-1),V=n("p",null,[a("Java中提供了: "),n("code",null,"java.util.concurrent.locks.Lock"),a("接口作为显式锁，与内置加锁机制不同的是，Lock提供了一种无条件的、可轮询的、定时的以及可中断的锁获取操作，所有加锁和解锁方法都是显式的、在Lock的实现中必须提供与内部锁相同的内存可见性语义，但在加锁语义、调度算法和顺序保证以及性能特性等方面可以有所不同。")],-1),B={id:"_2-1-lock",tabindex:"-1"},E=n("a",{class:"header-anchor",href:"#_2-1-lock","aria-hidden":"true"},"#",-1),D={href:"https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/concurrent/locks/Lock.html",target:"_blank",rel:"noopener noreferrer"},H=t(`<h4 id="_2-1-1-lock的使用方式" tabindex="-1"><a class="header-anchor" href="#_2-1-1-lock的使用方式" aria-hidden="true">#</a> 2.1.1 Lock的使用方式:</h4><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token class-name">Lock</span> l <span class="token operator">=</span> <span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">;</span>  
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10);function q(X,R){const s=p("ExternalLinkIcon");return o(),c("div",null,[d,n("div",r,[u,n("p",null,[n("a",v,[a("临界区"),e(s)]),a("指的是某一块在同一时刻只能由一个线程执行的代码区域")])]),k,n("p",null,[a("第一类是用于存储对象自身的运行时数据，如哈希码、GC分代年龄，锁状态标志、线程持有的锁、偏向线程ID、偏向时间戳等，称为"),h,a("。在JDK17中 "),n("a",b,[a("markWord.hpp"),e(s)]),a("中描述如下")]),m,n("div",g,[_,n("p",null,[y,a(" (Java Object Layout) 是分析对象内存布局的工具。详情点击: "),n("a",f,[a("openjdk/jol"),e(s)])])]),w,n("blockquote",null,[n("p",null,[n("a",j,[a("biasedLocking.hpp"),e(s)])])]),x,L,C,n("div",z,[J,n("p",null,[a("偏向锁在Java15中废弃，参考: "),n("a",A,[a("jeps-374"),e(s)])])]),I,n("div",S,[M,n("p",null,[n("a",T,[a("objectMonitor.hpp"),e(s)])]),n("p",null,[n("a",W,[a("objectMonitor.cpp"),e(s)])])]),N,O,V,n("h3",B,[E,a(" 2.1 "),n("a",D,[a("Lock"),e(s)])]),H])}const P=i(l,[["render",q],["__file","locks.html.vue"]]);export{P as default};
