import{_ as n,V as s,W as a,a4 as e}from"./framework-b6120433.js";const t={},p=e(`<h1 id="python脚本" tabindex="-1"><a class="header-anchor" href="#python脚本" aria-hidden="true">#</a> Python脚本</h1><h2 id="_1-读取-csv文件" tabindex="-1"><a class="header-anchor" href="#_1-读取-csv文件" aria-hidden="true">#</a> 1. 读取.csv文件</h2><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">read_csv</span><span class="token punctuation">(</span>path<span class="token punctuation">)</span><span class="token punctuation">:</span>
